...
define( 'NextScripts_SNAP_Version' , '4.3.16' ); define( 'NextScripts_SNAP_Version_Date' , 'July  15, 2020' ); require_once "inc/nxs_functions_wp.php"; if(!defined( 'NXSSNAP_BASENAME' ) ) define( 'NXSSNAP_BASENAME', plugin_basename( __FILE__ ) );
